...
do
    ...
    if [ ! $error ]; then
        echo "--- INDEXING TITLE"
        echo '---+---' $cisis_dir/mx ../input/$collection/title "\"fst='1 0 |ISSN_|v400,/'\"" fullinv=../input/$collection/title
        $cisis_dir/mx ../input/$collection/title "\"fst='1 0 |ISSN_|v400,/'\"" fullinv=../input/$collection/title
    fi
done
